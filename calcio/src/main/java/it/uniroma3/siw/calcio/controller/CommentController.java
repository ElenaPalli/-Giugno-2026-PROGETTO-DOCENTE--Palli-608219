...
public class CommentController {
    ...
    public String addComment(@PathVariable("matchId") Long matchId,
    ...
    public String updateComment(@PathVariable Long id, @Valid @ModelAttribute("comment") Comment updatedComment,
        ...
        if (commentOpt.isPresent()) {
            ...
            if (principal instanceof UserDetails) {
                ...
                if (credentials.getRole().equals("ADMIN")
                        || existingComment.getAuthor().getId().equals(credentials.getUser().getId())) {
