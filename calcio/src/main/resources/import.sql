...
insert into "match" (id, "date", "time", goals_home, goals_away, state, tournament_id, home_team_id, away_team_id, referee_id) values(nextval('match_seq'), '2026-06-27', '20:45:00', 0, 0, 'SCHEDULED', (select id from tournament where name = 'Serie A' and year = 2026), (select id from team where name = 'Milan'), (select id from team where name = 'Roma'), (select id from referee where referee_code = 'R-1001'));
