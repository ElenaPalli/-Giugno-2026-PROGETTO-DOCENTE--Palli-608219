...
insert into "match" (id, "date", "time", goals_home, goals_away, state, tournament_id, home_team_id, away_team_id, referee_id) values(nextval('match_seq'), '2025-09-01', '20:45:00', 0, 0, 'PLAYED', (select id from tournament where name = 'Serie A' and "year" = 2025), (select id from team where name = 'Roma'), (select id from team where name = 'Lazio'), (select id from referee where referee_code = 'R-1001'));
insert into "match" (id, "date", "time", goals_home, goals_away, state, tournament_id, home_team_id, away_team_id, referee_id) values(nextval('match_seq'), '2025-09-07', '18:00:00', 0, 0, 'SCHEDULED', (select id from tournament where name = 'Serie A' and "year" = 2025), (select id from team where name = 'Juventus'), (select id from team where name = 'Milan'), (select id from referee where referee_code = 'R-1002'));
insert into "match" (id, "date", "time", goals_home, goals_away, state, tournament_id, home_team_id, away_team_id, referee_id) values(nextval('match_seq'), '2025-10-15', '21:00:00', 2, 1, 'PLAYED', (select id from tournament where name = 'Coppa Italia' and "year" = 2025), (select id from team where name = 'Inter'), (select id from team where name = 'Roma'), (select id from referee where referee_code = 'R-1001'));
